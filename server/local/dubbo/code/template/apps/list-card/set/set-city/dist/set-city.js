(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("immutable"), require("MK.metaEngine"), require("react"), require("mk-aar-form"), require("MK.utils"));
	else if(typeof define === 'function' && define.amd)
		define(["immutable", "MK.metaEngine", "react", "mk-aar-form", "MK.utils"], factory);
	else if(typeof exports === 'object')
		exports["set-city"] = factory(require("immutable"), require("MK")["metaEngine"], require("react"), require("mk-aar-form"), require("MK.utils"));
	else
		root["set-city"] = factory(root["Immutable"], root["MK.metaEngine"], root["React"], root["mk-aar-form"], root["MK"]["utils"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_131__, __WEBPACK_EXTERNAL_MODULE_38__, __WEBPACK_EXTERNAL_MODULE_57__, __WEBPACK_EXTERNAL_MODULE_130__, __WEBPACK_EXTERNAL_MODULE_45__) {
...
var action = (_temp = _class = function action(option) {
    ...
    this.onInit = function (_ref) {
        ...
        _this.extendAction.formAction.onInit({ component: component, injections: injections });
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        if (!(_this.component.props.cityId || _this.component.props.cityId == 0)) {
                            _context.next = 5;
                            break;
                        }

                        _context.next = 3;
                        return _this.webapi.city.findById(_this.component.props.cityId);
    ...
    this.onOk = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
    ...
    this.save = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
        var form, ok, response, _response;
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        _context3.next = 3;
                        return _this.extendAction.formAction.check([{
                    ...
                    case 6:
                        ...
                        _context3.next = 9;
                        return _this.webapi.city.update(form);
                    ...
                    case 9:
                        ...
                        _this.metaAction.toast('success', '修改城市成功');
                        _this.injections.reduce('load', response);
                    ...
                    case 16:
                        _context3.next = 18;
                        return _this.webapi.city.create(form);
                    ...
                    case 18:
                        ...
                        _this.metaAction.toast('success', '新增城市成功');
                        _this.injections.reduce('load', _response);
    ...
    this.check = function () {
        var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(option) {
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        ...
                        case 2:
                            ...
                            return _context4.abrupt('return', { errorPath: 'data.other.error.name', message: option.value ? '' : '请录入城市名称' });
                        ...
                        case 6:
                            ...
                            return _context4.abrupt('return', { errorPath: 'data.other.error.code', message: option.value ? '' : '请录入城市编码' });
    ...
    this.fieldChange = function (path, value) {
        _this.extendAction.formAction.fieldChange(path, value, _this.check);
    };
}, _temp);
function creator(option) {
    var metaAction = new _mkMetaEngine.action(option),
        extendAction = _extend2.default.actionCreator((0, _extends3.default)({}, option, { metaAction: metaAction })),
        o = new action((0, _extends3.default)({}, option, { metaAction: metaAction, extendAction: extendAction })),
        ret = (0, _extends3.default)({}, metaAction, extendAction.formAction, o);
...
var _immutable = __webpack_require__(131);
...
var reducer = function reducer(option) {
    ...
    this.load = function (state, form) {
        state = _this.metaReducer.sf(state, 'data.form', (0, _immutable.fromJS)(form));
        return _this.metaReducer.sf(state, 'data.other.checkFields', (0, _immutable.List)());
    };
...
__webpack_require__.p = window["__pub_set-city__"];
...
var _mkUtils = __webpack_require__(45);
...
exports.default = {
    city: {
        findById: function findById(id) {
            return _mkUtils.fetch.post(_config2.default.current.webapiMap['city.findById'], { id: id });
        },
        create: function create(option) {
            return _mkUtils.fetch.post(_config2.default.current.webapiMap['city.create'], option);
        },
        update: function update(option) {
            return _mkUtils.fetch.post(_config2.default.current.webapiMap['city.update'], option);
        }
    }
};
module.exports = exports['default'];
...
_mkUtils.fetch.mock('/v1/supplier/findById', function (option) {
    initMockData();

    var supplier = mockData.suppliers.find(function (o) {
...
_mkUtils.fetch.mock('/v1/supplier/create', function (option) {
    initMockData();

    var id = mockData.suppliers.length;
    var v = (0, _extends3.default)({}, option, { id: id });
    mockData.suppliers.push(v);

    return { result: true, value: v };
});

_mkUtils.fetch.mock('/v1/supplier/update', function (option) {
    initMockData();
...
var _mkAarForm = __webpack_require__(130);

var _mkAarForm2 = _interopRequireDefault(_mkAarForm);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function actionCreator(option) {
    return {
        formAction: new _mkAarForm2.default.action(option)
    };
}
