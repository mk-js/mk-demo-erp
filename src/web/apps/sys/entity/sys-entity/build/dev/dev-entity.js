(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MakaApp-sys-entity"] = factory(require("maka"), require("react"));
	else
		root["MakaApp-sys-entity"] = factory(root["maka"], root["react"]);
...
module.exports = {"isMakaApp":true,"name":"sys-entity","description":"sys-entity","version":"1.0.0","license":"MIT","author":"","repository":{"type":"git","url":"https://github.com/makajs/sys-entity.git"},"bugs":{"url":"https://github.com/makajs/sys-entity/issues"},"homepage":"https://github.com/makajs/sys-entity#readme","scripts":{"start":"maka start","dev":"maka start --dev","build":"maka build","pkg":"maka pkg"},"dependencies":{},"server":{"proxy":null,"port":8000},"subAppDir":"./apps"};
...
/* harmony default export */ var view = ({
  ...
  children: [{
    ...
    children: [{
      type: 'select',
      title: '所属组',
      bindPath: 'data.form.entityGroup',
      required: true,
      onLoadOption: '{{$loadEntityGroup}}',
    ...
    columns: [{
      ...
      bindField: 'typeName',
      required: true,
      onLoadOption: '{{$loadTypeNames}}',
      titleGetter: '{{(v)=> v && v.code || v}}',
      displayGetter: "{{(v)=> v && '(' + v.code + ')' + v.name}}"
    }, {
      type: 'text',
      title: '参数',
...
// EXTERNAL MODULE: C:/Users/jenmy/AppData/Roaming/npm/node_modules/@makajs/cli/node_modules/@babel/runtime/regenerator/index.js
var regenerator = __webpack_require__(0);
var regenerator_default = /*#__PURE__*/__webpack_require__.n(regenerator);

// EXTERNAL MODULE: C:/Users/jenmy/AppData/Roaming/npm/node_modules/@makajs/cli/node_modules/@babel/runtime/helpers/asyncToGenerator.js
var asyncToGenerator = __webpack_require__(3);
var asyncToGenerator_default = /*#__PURE__*/__webpack_require__.n(asyncToGenerator);

// EXTERNAL MODULE: C:/Users/jenmy/AppData/Roaming/npm/node_modules/@makajs/cli/node_modules/@babel/runtime/helpers/classCallCheck.js
var classCallCheck = __webpack_require__(6);
var classCallCheck_default = /*#__PURE__*/__webpack_require__.n(classCallCheck);

// EXTERNAL MODULE: C:/Users/jenmy/AppData/Roaming/npm/node_modules/@makajs/cli/node_modules/@babel/runtime/helpers/createClass.js
var createClass = __webpack_require__(7);
var createClass_default = /*#__PURE__*/__webpack_require__.n(createClass);

// EXTERNAL MODULE: C:/Users/jenmy/AppData/Roaming/npm/node_modules/@makajs/cli/node_modules/@babel/runtime/helpers/defineProperty.js
var defineProperty = __webpack_require__(2);
...
function () {
  function action(option) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (!(_this.component.props.entityId || _this.component.props.entityId == 0)) {
                _context.next = 7;
                break;
              }

              _context.next = 5;
              return external_maka_["fetch"].post('/v1/sys/entity/query', {
                id: _this.component.props.entityId
              });

            case 5:
              resp = _context.sent;

              _this.setForm(resp[0]);
      ...
      return regenerator_default.a.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 5:
              _context3.next = 7;
              return external_maka_["fetch"].post('/v1/sys/entity/prev', {
      ...
      return regenerator_default.a.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 5:
              _context4.next = 7;
              return external_maka_["fetch"].post('/v1/sys/entity/next', {
                id: _this.base.gs('data.form.id')
              });
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 5:
              ...
              _context6.next = 9;
              return external_maka_["fetch"].post('/v1/sys/entity/update', form);
            ...
            case 12:
              _context6.next = 14;
              return external_maka_["fetch"].post('/v1/sys/entity/create', form);
            ...
            case 15:
              ...
              _this.message.success(isModify ? '修改实体成功' : '新增实体成功');
    ...
    defineProperty_default()(this, "addRow", function (rowIndex) {
      return function () {
        var lst = _this.base.gs('data.form.fields');

        lst.splice(rowIndex + 1, 0, state.data.form.fields[0]);

        _this.base.ss({
          'data.form.fields': lst
        });
      };
    });
    ...
    defineProperty_default()(this, "loadEntityGroup",
    /*#__PURE__*/
    asyncToGenerator_default()(
    /*#__PURE__*/
      ...
      return regenerator_default.a.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return external_maka_["fetch"].post('/v1/sys/entity/group/queryPageList', {});

            case 2:
              res = _context7.sent;
              return _context7.abrupt("return", res.list);
    ...
    defineProperty_default()(this, "loadTypeNames",
    /*#__PURE__*/
    asyncToGenerator_default()(
    /*#__PURE__*/
      ...
      return regenerator_default.a.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              lst = _this.base.gs('data.other.typeNames');
              return _context8.abrupt("return", lst);
    ...
    defineProperty_default()(this, "genCode",
    /*#__PURE__*/
    asyncToGenerator_default()(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              _this.message.error('请先保存实体');

              return _context11.abrupt("return");

            case 4:
              _context11.next = 6;
              return external_maka_["fetch"].post('/v1/sys/entity/genCode', [{
                id: id
              }]);

            case 6:
              _this.message.success('生成代码成功');
  ...
  createClass_default()(action, [{
    ...
    value: function checkSave(form) {
      ...
      if (form.fields.length == 0) msg.push("\u5B9E\u4F53\u81F3\u5C11\u9700\u8981\u4E00\u884C\u660E\u7EC6\u4FE1\u606F\uFF01");
      form.fields.forEach(function (d, index) {
        !d.code && msg.push("\u660E\u7EC6\u7B2C".concat(index + 1, "\u884C\uFF0C\u7F16\u53F7\u4E0D\u80FD\u4E3A\u7A7A\uFF01"));
        !d.name && msg.push("\u660E\u7EC6\u7B2C".concat(index + 1, "\u884C\uFF0C\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A\uFF01"));
        !d.typeName && msg.push("\u660E\u7EC6\u7B2C".concat(index + 1, "\u884C\uFF0C\u7C7B\u578B\u4E0D\u80FD\u4E3A\u7A7A\uFF01"));
      });
      return msg;
    }
  }]);
...
// EXTERNAL MODULE: C:/Users/jenmy/AppData/Roaming/npm/node_modules/@makajs/cli/node_modules/@babel/runtime/helpers/objectSpread.js
...
external_maka_["fetch"].mock('/v1/sys/entity/findById', function (option) {
  initMockData();
  var entity = mockData.entitys.find(function (o) {
...
external_maka_["fetch"].mock('/v1/sys/entity/prev', function (option) {
  initMockData();
  ...
  var index = 0;
  if (option.id || option.id == 0) index = mockData.entitys.findIndex(function (o) {
    return o.id == option.id;
  });else index = mockData.entitys.length;
...
external_maka_["fetch"].mock('/v1/sys/entity/next', function (option) {
  initMockData();
...
external_maka_["fetch"].mock('/v1/sys/entity/create', function (option) {
  initMockData();
  var id = mockData.entitys.length;
...
external_maka_["fetch"].mock('/v1/sys/entity/update', function (option) {
  initMockData();
  var index = mockData.entitys.findIndex(function (o) {
    return o.id == option.id;
  });
