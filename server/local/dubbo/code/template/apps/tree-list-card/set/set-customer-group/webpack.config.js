...
const extractCSS = new ExtractTextPlugin("set-customer-group.css");
...
module.exports = {
    entry: ["./index.umd.js"],
    output: {
        filename: env === 'production' ? 'set-customer-group.min.js': 'set-customer-group.js',
        path: path.join(__dirname, "/dist/"),
        library: "set-customer-group",
        libraryTarget: "umd"
    },
