(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("immutable"), require("MK.metaEngine"), require("react"), require("MK.utils"), require("moment"));
	else if(typeof define === 'function' && define.amd)
		define(["immutable", "MK.metaEngine", "react", "MK.utils", "moment"], factory);
	else if(typeof exports === 'object')
		exports["set-city-list"] = factory(require("immutable"), require("MK")["metaEngine"], require("react"), require("MK.utils"), require("moment"));
	else
		root["set-city-list"] = factory(root["Immutable"], root["MK.metaEngine"], root["React"], root["MK"]["utils"], root["moment"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_130__, __WEBPACK_EXTERNAL_MODULE_39__, __WEBPACK_EXTERNAL_MODULE_57__, __WEBPACK_EXTERNAL_MODULE_34__, __WEBPACK_EXTERNAL_MODULE_74__) {
			...
			children: [{
				...
				children: [{
					...
					overlay: {
						...
						children: [getSortMenuItem('default', '默认'), getSortMenuItem('codeDesc', '编码从大到小'), getSortMenuItem('codeAsc', '编码从小到大'), getSortMenuItem('nameDesc', '名称从大到小'), getSortMenuItem('nameAsc', '名称从小到大')]
					},
					children: {
						name: 'sort',
						component: 'Button',
...
var _mkUtils = __webpack_require__(34);
...
var action = function action(option) {
    ...
    this.load = function () {
        var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(pagination) {
            var filter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { orderBy: 'default' };
            var orderBy, response;
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.t0 = filter.orderBy;
                            _context.next = _context.t0 === 'default' ? 3 : _context.t0 === 'codeDesc' ? 5 : _context.t0 === 'codeAsc' ? 7 : _context.t0 === 'nameDesc' ? 9 : _context.t0 === 'nameAsc' ? 11 : 13;
                            break;
                        ...
                        case 13:
                            _context.next = 15;
                            return _this.webapi.city.queryPageList({
    ...
    this.reload = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
        var pagination, filter;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        pagination = _this.metaAction.gf('data.pagination').toJS(), filter = _this.metaAction.gf('data.filter').toJS();
            ...
            return _regenerator2.default.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            _context3.next = 2;
                            return _this.metaAction.modal('confirm', {
                                title: '删除',
                                content: '确认删除?'
                            });
                        ...
                        case 5:
                            id = row.id, ts = row.ts;
                            _context3.next = 8;
                            return _this.webapi.city.del({ id: id, ts: ts });
                    ...
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            ...
                            return _this.metaAction.modal('show', {
                                title: '城市',
                                children: _this.metaAction.loadApp('set-city', {
    ...
    this.add = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5() {
        var ret;
    ...
    this.searchChange = _mkUtils2.default._.debounce(function (v) {
        var pagination = _this.metaAction.gf('data.pagination').toJS(),
            filter = _this.metaAction.gf('data.filter').toJS();

        filter.search = v;
        _this.load(pagination, filter);
    }, 200);

    this.sortSelected = function (_ref7) {
        var key = _ref7.key;
...
var reducer = function reducer(option) {
    ...
    this.load = function (state, response) {
        ...
        response.filter.search = _this.metaReducer.gf(state, 'data.filter.search');
...
__webpack_require__.p = window["__pub_set-city-list__"];
...
exports.default = {
    city: {
        query: function query(option) {
            return _mkUtils.fetch.post(_config2.default.current.webapiMap['city.query'], option);
        },
        queryPageList: function queryPageList(option) {
            return _mkUtils.fetch.post(_config2.default.current.webapiMap['city.queryPageList'], option);
        },
        del: function del(option) {
            return _mkUtils.fetch.post(_config2.default.current.webapiMap['city.del'], option);
        }
    }
};
module.exports = exports['default'];
...
_mkUtils.fetch.mock('/v1/set/city/queryPageList', function (option) {
    initMockData();
    ...
    ret.value.list = ret.value.list.map(function (o) {
        return (0, _extends3.default)({}, o);
    });
    return ret;
});

_mkUtils.fetch.mock('/v1/set/city/delete', function (option) {
    initMockData();
    var id = option.id,
        ts = option.ts;

    var index = mockData.citys.findIndex(function (o) {
        return o.id == id;
    });
    if (index || index === 0) mockData.citys.splice(index, 1);
