export default {
    ...
    children: [{
        ...
        extra: {
            ...
            children: [
                { component: 'antd.Button', className: 'button-bluesky', onClick: '{{$genEntity}}', children: '生成实体' },
                { component: 'antd.Button', className: 'button-bluesky', onClick: '{{$genCode}}', children: '下载代码' },
