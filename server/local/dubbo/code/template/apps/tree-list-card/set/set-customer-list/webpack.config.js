...
const extractCSS = new ExtractTextPlugin("set-customer-list.css");
...
module.exports = {
    entry: ["./index.umd.js"],
    output: {
        filename: env === 'production' ? 'set-customer-list.min.js': 'set-customer-list.js',
        path: path.join(__dirname, "/dist/"),
        library: "set-customer-list",
        libraryTarget: "umd"
    },
